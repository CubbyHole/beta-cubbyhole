...
require_once $projectRoot.'/model/classes/Payment.class.php';
...
require_once $projectRoot.'/model/interfaces/PaymentManager.interface.php';
...
require_once $projectRoot.'/model/pdo/PaymentPdoManager.class.php';
